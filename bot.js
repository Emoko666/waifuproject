...
message.channel.bulkDelete(messages).catch(err => errormsg(message, err, "clear")).then(()=> message.channel.send(`<:megThumbs:475427359898599441> Cleared **${message.size}** messages.`).then(msg => msg.delete(3000)));
}
///////////////////////////////PREMIUM////////////////////////////////////

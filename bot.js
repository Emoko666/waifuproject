...
client.on('guildMemberAdd', member => {
    ...
    member.guild.channels.get("347377586017665027").send(`O New Pal ${member} jumped in メ NightCorePals メ ! Welcome :Wave: have a fun time here ^^`, {files: ["https://i.imgur.com/kfQDwer.jpg"]})
})
/////////////// Other Client Events //////////////////
